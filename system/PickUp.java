...
public class PickUp extends JFrame {
	...
	public PickUp() throws SQLException {
		...
		lblInfo.setBounds(28, 208, 46, 14);
		...
		btnRegister.setBounds(200, 487, 120, 30);
		...
		btnExit.setBounds(420, 487, 120, 30);
                btnExit.setBackground(Color.BLACK);
                btnExit.setForeground(Color.WHITE);
		contentPane.add(btnExit);
		
		table = new JTable();
		table.setBounds(10, 233, 770, 250);
		...
		lblGender.setBounds(280, 208, 46, 14);
		contentPane.add(lblGender);
		
		JLabel lblTypeOfDriver = new JLabel("Company");
		lblTypeOfDriver.setBounds(408, 208, 80, 14);
		...
		lblAirport.setBounds(539, 208, 86, 14);
		contentPane.add(lblAirport);
		
		JLabel lblAvailable = new JLabel("Location");
		lblAvailable.setBounds(655, 208, 73, 14);
